...
*/
abstract class ToDoNotiz implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ToDoNotizTableMap';
    ...
    /**
     * Initializes internal state of Base\ToDoNotiz object.
     */
    ...
    /**
     * Compares this with another <code>ToDoNotiz</code> instance.  If
     * <code>obj</code> is an instance of <code>ToDoNotiz</code>, delegates to
     * <code>equals(ToDoNotiz)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|ToDoNotiz The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[ToDoNotizTableMap::COL_ID] = true;
        }
    ...
    public function setNotizId($v)
    {
        ...
        if ($this->notiz_id !== $v) {
            $this->notiz_id = $v;
            $this->modifiedColumns[ToDoNotizTableMap::COL_NOTIZ_ID] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[ToDoNotizTableMap::COL_STATUS] = true;
        }
    ...
    /**
     * Set the value of [prior] column.
     *
     * @param  int $v new value
     * @return $this|\ToDoNotiz The current object (for fluent API support)
     */
    public function setPrior($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->prior !== $v) {
            $this->prior = $v;
            $this->modifiedColumns[ToDoNotizTableMap::COL_PRIOR] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ToDoNotizTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
            $this->id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ToDoNotizTableMap::translateFieldName('NotizId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->notiz_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ToDoNotizTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildToDoNotizQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see ToDoNotiz::setDeleted()
     * @see ToDoNotiz::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildToDoNotizQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ToDoNotizTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ToDoNotizTableMap::COL_ID)) {
            $modifiedColumns[':p' . $index++]  = 'id';
        }
        if ($this->isColumnModified(ToDoNotizTableMap::COL_NOTIZ_ID)) {
            $modifiedColumns[':p' . $index++]  = 'notiz_id';
        }
        if ($this->isColumnModified(ToDoNotizTableMap::COL_STATUS)) {
    ...
    {
        $pos = ToDoNotizTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['ToDoNotiz'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['ToDoNotiz'][$this->hashCode()] = true;
        $keys = ToDoNotizTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ToDoNotizTableMap::COL_ID)) {
            $criteria->add(ToDoNotizTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(ToDoNotizTableMap::COL_NOTIZ_ID)) {
            $criteria->add(ToDoNotizTableMap::COL_NOTIZ_ID, $this->notiz_id);
        }
        if ($this->isColumnModified(ToDoNotizTableMap::COL_STATUS)) {
            $criteria->add(ToDoNotizTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(ToDoNotizTableMap::COL_PRIOR)) {
    ...
    {
        $criteria = ChildToDoNotizQuery::create();
        $criteria->add(ToDoNotizTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \ToDoNotiz (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \ToDoNotiz Clone of current object.
     * @throws PropelException
     */
    ...
    public function getNotiz(ConnectionInterface $con = null)
    {
        if ($this->aNotiz === null && ($this->notiz_id !== null)) {
            ...
            /* The following can be used additionally to
                ...
                $this->aNotiz->addToDoNotizs($this);
             */
        }
    ...
    {
        if (null !== $this->aNotiz) {
            $this->aNotiz->removeToDoNotiz($this);
        }
        $this->id = null;
        $this->notiz_id = null;
        $this->status = null;
