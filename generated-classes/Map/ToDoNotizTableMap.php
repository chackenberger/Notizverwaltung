...
class ToDoNotizTableMap extends TableMap
{
     ...
     */
    const COL_CREATED_AT = 'todo_notiz.created_at';

    /**
     * the column name for the updated_at field
     */
    const COL_UPDATED_AT = 'todo_notiz.updated_at';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'NotizId', 'Status', 'Prior', 'CreatedAt', 'UpdatedAt', ),
        self::TYPE_CAMELNAME     => array('id', 'notizId', 'status', 'prior', 'createdAt', 'updatedAt', ),
        self::TYPE_COLNAME       => array(ToDoNotizTableMap::COL_ID, ToDoNotizTableMap::COL_NOTIZ_ID, ToDoNotizTableMap::COL_STATUS, ToDoNotizTableMap::COL_PRIOR, ToDoNotizTableMap::COL_CREATED_AT, ToDoNotizTableMap::COL_UPDATED_AT, ),
        self::TYPE_FIELDNAME     => array('id', 'notiz_id', 'status', 'prior', 'created_at', 'updated_at', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'NotizId' => 1, 'Status' => 2, 'Prior' => 3, 'CreatedAt' => 4, 'UpdatedAt' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'notizId' => 1, 'status' => 2, 'prior' => 3, 'createdAt' => 4, 'updatedAt' => 5, ),
        self::TYPE_COLNAME       => array(ToDoNotizTableMap::COL_ID => 0, ToDoNotizTableMap::COL_NOTIZ_ID => 1, ToDoNotizTableMap::COL_STATUS => 2, ToDoNotizTableMap::COL_PRIOR => 3, ToDoNotizTableMap::COL_CREATED_AT => 4, ToDoNotizTableMap::COL_UPDATED_AT => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'notiz_id' => 1, 'status' => 2, 'prior' => 3, 'created_at' => 4, 'updated_at' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(ToDoNotizTableMap::COL_CREATED_AT);
            $criteria->addSelectColumn(ToDoNotizTableMap::COL_UPDATED_AT);
        } else {
